...
insert into Reimbursements(UserName, Amount, ReimbursementType, ReimbursementStatus, ReimbursementDesc,CreationDate) values ('JobEmployee', 250, 'Relocation', 'Submitted','Gas and Hotel','11/05/2018');
insert into Reimbursements(UserName, Amount, ReimbursementType, ReimbursementStatus, ReimbursementDesc,CreationDate) values ('JobEmployee', 200, 'Certification', 'Submitted','Java OCA','05/14/2019');

insert into Reimbursements(UserName, Amount, ReimbursementType, ReimbursementStatus, ReimbursementDesc,CreationDate) values ('KennyEmployee', 350, 'Relocation', 'Submitted','Gas and Food','06/24/2019');
insert into Reimbursements(UserName, Amount, ReimbursementType, ReimbursementStatus, ReimbursementDesc,CreationDate) values ('KennyEmployee', 230, 'Certification', 'Submitted','Java OCA','06/18/2019');
